package com.xiaofang.floatwindow.service
...
import com.xiaofang.floatwindow.R
import com.xiaofang.floatwindow.databinding.FloatWindowBinding
import androidx.core.view.isGone
import com.xiaofang.floatwindow.MainActivity
import com.xiaofang.floatwindow.databinding.LayoutToastBinding
import com.xiaofang.floatwindow.manager.ScreenCaptureManager
import com.xiaofang.floatwindow.manager.ScriptExecutor
...
class FloatWindowService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        setTheme(R.style.Theme_FloatWindow)
    ...
    private fun initFloatWindow() {
        ...
        binding.btnCloseScript.setOnClickListener {
            ...
            val intent = Intent("com.xiaofang.floatwindow.ACTION_EXIT")
